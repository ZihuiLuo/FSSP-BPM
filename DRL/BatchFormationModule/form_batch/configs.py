...
def ParseParams():
    ...
    parser.add_argument('--training_epochs', default=3000, type=int, help='Number of training epochs')
    parser.add_argument('--data_num', default=29654, type=int, help='Number of training data')
    ...
    parser.add_argument("--gpu", default='2,3', type=str, help="gpu number.")
    #parser.add_argument('--log_interval', default=400, type=int, help='Log info every log_step steps')
    parser.add_argument('--test_interval', default=5, type=int, help='test every epoch')
    parser.add_argument('--save_interval', default=5, type=int, help='save every epoch')
    # parser.add_argument('--save_interval', default=10000, type=int, help='save every save_interval steps')
    parser.add_argument('--log_dir', type=str, default='logs')
    parser.add_argument('--data_dir', type=str, default='data')
    parser.add_argument('--model_dir', type=str, default='')
    parser.add_argument('--load_path', type=str, default='./FSSP-BPM/DRL/BatchFormationModule/form_batch/logs/vrp100-2021-02-01_14-29-42/model', help='Path to load trained variables')
