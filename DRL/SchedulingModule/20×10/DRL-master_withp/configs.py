...
def ParseParams():
    ...
    parser.add_argument("--gpu", default='1,2', type=str, help="gpu number.")
    ...
    parser.add_argument('--load_path', type=str, default='./FSSP-BPM/DRL/SchedulingModule/20×10/DRL-master_withp/logs/vrp20-2021-02-17_09-00-58/model', help='Path to load trained variables')
