...
def ParseParams():
    ...
    # Data
    parser.add_argument('--task', default='vrp50', help="Select the task to solve; i.e. vrp50")
    ...
    parser.add_argument('--n_train', default=40000, type=int, help='Number of training steps')
    parser.add_argument('--test_size', default=1, type=int, help='Number of problems in test set')
    ...
    parser.add_argument('--n_glimpses', default=1, type=int, help='Number of glimpses to use in the attention')
    ...
    parser.add_argument('--depot_num', nargs='+',default=[3,3,3,1], type=int, help='depot of each stage')
    parser.add_argument('--stage_num', default=4, type=int, help='number of stage')
    ...
    parser.add_argument("--gpu", default='0,1,3,7', type=str, help="gpu number.")
    parser.add_argument('--log_interval', default=400, type=int, help='Log info every log_step steps')
    parser.add_argument('--test_interval', default=400, type=int, help='test every test_interval steps')
    parser.add_argument('--save_interval', default=400, type=int, help='save every save_interval steps')
    # parser.add_argument('--save_interval', default=10000, type=int, help='save every save_interval steps')
    parser.add_argument('--log_dir', type=str, default='logs')
    parser.add_argument('--data_dir', type=str, default='data')
    parser.add_argument('--model_dir', type=str, default='')
    parser.add_argument('--load_path', type=str, default='./FSSP-BPM/DRL/SchedulingModule/NISCO/logs/vrp50-2021-04-26_20-27-47/model', help='Path to load trained variables')
