...
def ParseParams():
    ...
    # Data
    parser.add_argument('--task', default='vrp20', help="Select the task to solve; i.e. tsp20")
    ...
    parser.add_argument('--training_epochs', default=300, type=int, help='Number of training steps')
    ...
    parser.add_argument('--depot_num', nargs='+',default=[1]*5, type=int, help='depot of each stage')
    parser.add_argument('--stage_num', default=5, type=int, help='number of stage')
    ...
    parser.add_argument("--gpu", default='5,6', type=str, help="gpu number.")
    ...
    parser.add_argument('--load_path', type=str, default='./FSSP-BPM/DRL/SchedulingModule/20×5/DRL-master_withp/logs/vrp20-2021-02-17_08-58-38/model', help='Path to load trained variables')
