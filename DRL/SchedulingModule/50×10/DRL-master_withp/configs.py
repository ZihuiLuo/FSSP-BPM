...
def ParseParams():
    ...
    # Data
    parser.add_argument('--task', default='vrp50', help="Select the task to solve; i.e. tsp50")
    ...
    parser.add_argument('--training_epochs', default=3000, type=int, help='Number of training steps')
    parser.add_argument('--data_num', default=20000, type=int, help='Number of training data')
    ...
    parser.add_argument('--load_path', type=str, default='.\FSSP-BPM/DRL/SchedulingModule/50×10/DRL-master_withp/logs/vrp50-2021-02-08_13-06-47/model', help='Path to load trained variables')
