...
def ParseParams():
    ...
    # Data
    parser.add_argument('--task', default='vrp100', help="Select the task to solve; i.e. tsp10")
    parser.add_argument('--batch_size', default=20, type=int, help='Batch size in training')
    # parser.add_argument('--n_train', default=260000,type=int, help='Number of training steps')
    parser.add_argument('--training_epochs', default=800, type=int, help='Number of training steps')
    parser.add_argument('--data_num', default=50000, type=int, help='Number of training data')
    parser.add_argument('--test_size', default=10, type=int, help='Number of problems in test set')
    ...
    parser.add_argument('--use_tanh', type=str2bool, default=True, help='')
    ...
    parser.add_argument('--depot_num', nargs='+',default=[1]*10, type=int, help='depot of each stage')
    parser.add_argument('--stage_num', default=10, type=int, help='number of stage')
    parser.add_argument('--epsilon', default=1.0, type=float, help='epsilon')

    # inference
    parser.add_argument('--infer_type', default='single',
                        help='single|batch: do inference for the decode_type one-by-one, or run it all at once')
    ...
    parser.add_argument("--gpu", default='6,7', type=str, help="gpu number.")
    #parser.add_argument('--log_interval', default=400, type=int, help='Log info every log_step steps')
    parser.add_argument('--test_interval', default=10, type=int, help='test every test_interval steps')
    parser.add_argument('--save_interval', default=10, type=int, help='save every save_interval steps')
    # parser.add_argument('--save_interval', default=10000, type=int, help='save every save_interval steps')
    parser.add_argument('--log_dir', type=str, default='logs')
    parser.add_argument('--data_dir', type=str, default='data')
    parser.add_argument('--model_dir', type=str, default='')
    parser.add_argument('--load_path', type=str, default='./FSSP-BPM/DRL/SchedulingModule/100×10/DRL-master_withp/logs/vrp100-2021-02-25_10-19-21/model', help='Path to load trained variables')
