...
def ParseParams():
    ...
    # Data
    parser.add_argument('--task', default='vrp100', help="Select the task to solve; i.e. tsp100")
    ...
    parser.add_argument('--training_epochs', default=1000, type=int, help='Number of training steps')
    ...
    parser.add_argument('--load_path', type=str, default='./FSSP-BPM/DRL/SchedulingModule/100×5/DRL-master_withp/logs/vrp100-2021-02-13_00-18-54/model', help='Path to load trained variables')
